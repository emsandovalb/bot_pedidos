    ...
    private function readyPayload(): array
    {
        return [
            ...
            'phases' => [
                ...
                ['name' => 'e2e', 'status' => 'passed', 'duration_seconds' => 24.3, 'command' => 'playwright test tests/e2e/pilot-documentation.spec.js'],
            ],
            'metrics' => [
            ...
            'artifacts' => [
                'screenshots' => [
                    '01-login.png',
                    '02-developer-toolkit.png',
                    '03-operations-home.png',
                    '04-do-now-order.png',
                    '05-order-drawer.png',
                    '06-order-preparing.png',
                    '07-order-ready.png',
                    '08-order-dispatched.png',
                    '09-completed-after-refresh.png',
                    '10-customer-detail.png',
                ],
