<x-app-layout>
    <div class="space-y-8">
        <section class="overflow-hidden rounded-3xl border border-slate-200/80 bg-[linear-gradient(135deg,rgba(20,110,219,0.08),rgba(22,163,74,0.08)_38%,rgba(255,255,255,1)_82%)] shadow-[0_24px_80px_-40px_rgba(15,23,42,0.35)]">
            <div class="px-6 py-8 sm:px-8 lg:px-10">
                <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div class="max-w-3xl">
                        <div class="inline-flex items-center rounded-full border border-brand-primary/10 bg-brand-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-brand-primary ring-1 ring-inset ring-blue-100">
                            Cierres diarios
                        </div>
        ...
        @if ($closures->isNotEmpty())
            <div class="grid gap-5 xl:grid-cols-2">
                @foreach ($closures as $closure)
                    <article class="group overflow-hidden rounded-3xl border border-slate-200/80 border-l-4 border-l-emerald-500 bg-white shadow-[0_18px_55px_-35px_rgba(15,23,42,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_26px_70px_-35px_rgba(15,23,42,0.55)]">
        ...
        @else
            <div class="rounded-3xl border border-dashed border-blue-200 bg-blue-50/70 px-6 py-14 text-center shadow-sm">
                <div class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-primary/10 text-brand-primary ring-1 ring-inset ring-blue-100">
